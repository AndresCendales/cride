# Generated by Django 3.1.2 on 2020-10-08 21:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Circcle admins can update the circles data and manage its members', verbose_name='circle admin')),
                ...
                ('is_active', models.BooleanField(default=True, help_text='Only  ative users are allowed to interacct in the circle', verbose_name='active status')),
                ('circle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='circles.circle', verbose_name='Circle')),
